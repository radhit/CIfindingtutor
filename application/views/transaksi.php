          ...
          <div class="">
            <div class="page-title">
              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title"> 
                    <h2>Rekap Transaksi (/Hari /Bulan /Tahun)</h2>
                  ...
                  <div class="x_content">
                      ...
                      <div class="dropdown">
                        <form method="get" action="<?php echo base_url("Welcome/transaksi")?>">
                    ...
                    <table id="datatable-buttons" class="table table-striped table-bordered" action="<?php echo base_url();?>Welcome/transaksi">
                      <thead>
                        <tr>
                          <th>ID</th>
                      ...
                      <tbody>
                        ...
                        <tr>
                          <td><?php echo $hasilUser->id_transaksi?></td>
                          <td><?php echo $hasilUser->tanggal?></td>
                          <td><?php echo $hasilUser->username_tutor?></td>
                          <td><?php echo $hasilUser->nameuser_pencarian?></td>
                          <td><?php echo $hasilUser->kelas_pencarian?></td>
                          <td><?php echo $hasilUser->pelajaran_pencarian?></td>
                          <td><?php echo $hasilUser->alamat_pencarian?></td>
                          <td><?php echo $hasilUser->durasi_pencarian?></td>
                          <td><?php echo $hasilUser->biayatutor_pencarian?></td>
                        </tr><?php }?>
                      </tbody>
                    </table>
