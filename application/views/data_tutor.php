          ...
          <div class="">
            <div class="page-title">
              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title"> 
                    <h2>Rekap Pendaftaran Tutor (/Hari /Bulan /Tahun)</h2>
                  ...
                  <div class="x_content">
					           <div class="dropdown">
                        <form method="get" action="<?php echo base_url("Welcome/data_tutor")?>">
                    ...
                    <table id="datatable-buttons" class="table table-striped table-bordered" action="<?php echo base_url();?>Welcome/tampilkan_tutor">
                      <thead>
                        <tr>
                          <th>ID USER</th>
                      ...
                      <tbody> <?php $i=0; foreach ($query as $hasilUser) { ?>
                      
                        <tr>
                          <td><?php echo $hasilUser->id_user?></td>
                          <td><?php echo $hasilUser->tanggal_daftar?></td>
                          <td><?php echo $hasilUser->nama_user?></td>
                          ...
                          <td><?php echo $hasilUser->jenis_user?></td>
                        </tr><?php }?>
                      </tbody>
                    </table>
