          ...
          <div class="">
            <div class="page-title">
              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title"> 
                    <h2>Rekap 5 Top Murid of The Month</h2>
                  ...
                  <div class="x_content">
                    ...
                    <table id="datatable-buttons" class="table table-striped table-bordered" action="<?php echo base_url();?>Welcome/murid_terbaik">
                      <thead>
                        <tr>
                          <th>NAMA MURID</th>
                          <th>ALAMAT</th>
                      ...
                      <tbody>
                        <?php $i=0; foreach ($query as $hasilUser) { ?>
                          <tr>
                           <td><?php echo $hasilUser->username_user?></td>
