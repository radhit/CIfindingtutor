<?php
	class pencariantutor_model extends CI_Model
	{
		...
		public function pencarianTutor($username, $name, $kelas, $pelajaran, $alamat, $tanggal, $hari, $jam, $durasi, $jeniskelamin, $usia)
		{
			$query = "INSERT INTO `pencarian_tutor`(`id_pencarian`, `username_pencarian`, `nameuser_pencarian`, `kelas_pencarian`, `pelajaran_pencarian`, `alamat_pencarian`, `tanggal_pencarian`, `hari_pencarian`, `jam_pencarian`, `durasi_pencarian` , `jktutor_pencarian`, `usiatutor_pencarian`) VALUES (NULL,'$username','$name','$kelas','$pelajaran','$alamat','$tanggal','$hari','$jam','$durasi','$jeniskelamin','$usia')";
